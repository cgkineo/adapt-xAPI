...
| \_contentRelease | String | `""` | The numbered release of the content. Increment this value when the content is iteratively released. This will help to organize testing & analysis of data by each release of content.
